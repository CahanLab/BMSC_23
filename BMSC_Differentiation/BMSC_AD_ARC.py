...
# AnnData object with n_obs × n_vars = 6014 × 221681
...
# AnnData object with n_obs × n_vars = 2646 × 180305
...
adata_all.write_loom('AD_clustered_GEX_ATAC_filtered_021723.loom', write_obsm_varm=True)
adata_atac_raw.write_loom("AD_ATAC_021723.loom", write_obsm_varm=True)
adata_atac_all.write_loom("AD_clustered_ATAC_021723.loom", write_obsm_varm=True)
adata_all.obs_names.to_frame().to_csv('AD_filtered_cells_021723.txt', header=False, index=False)

# we eventually obtain 2646 high quality nuclei
