...
# Import the file
# Please download the GSE234540_BMSC_day0_re2 data from GEO before start
...
# AnnData object with n_obs × n_vars = 5721 × 32285
...
adata_gem= adata_gem[adata_gem.obs['percent_mito'] < 0.8, :]

# View of AnnData object with n_obs × n_vars = 4921 × 17413
...
# View of AnnData object with n_obs × n_vars = 4921 × 17303
...
#Keep cluster 0, 1, 2, 3

# Save the File
adata_gem.write_loom('Day0_pre_clustered_GEX_030723.loom', write_obsm_varm=True)
adata_all.write_loom('Day0_clustered_GEX_030723.loom', write_obsm_varm=True)
...
# View of AnnData object with n_obs × n_vars = 2817 × 16483
...
# View of AnnData object with n_obs × n_vars = 2817 × 116605

# Add annotation
download.file("s3://cahanlab/ray.cheng/BMSC_2023/BMSC_Multipotency/GSE234540_BMSC_day0_re2_atac_peak_annotation.tsv", "atac_peak_annotation.tsv")
...
# AnnData object with n_obs × n_vars = 2817 × 116564
...
# AnnData object with n_obs × n_vars = 2637 × 115544
...
# Save the File
adata_all.write_loom('Day0_clustered_GEX_ATAC_filtered_030723.loom', write_obsm_varm=True)
adata_atac_raw.write_loom("Day0_ATAC_030723.loom", write_obsm_varm=True)
adata_atac_all.write_loom("Day0_clustered_ATAC_030723.loom", write_obsm_varm=True)
