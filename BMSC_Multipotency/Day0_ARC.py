...
# Import the file
# Please download the GSE234540_BMSC_day0_re1 data from GEO before start
...
# Add annotation
download.file("s3://cahanlab/ray.cheng/BMSC_2023/BMSC_Multipotency/GSE234540_BMSC_day0_re1_atac_peak_annotation.tsv", "atac_peak_annotation.tsv")
