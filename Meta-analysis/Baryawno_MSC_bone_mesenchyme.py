...
B_1 = sc.read("b1_4E06Z.loom", cache=True)
B_2 = sc.read("b2_FGP7Y.loom", cache=True)
B_3 = sc.read("b3_FJEW2.loom", cache=True)
B_4 = sc.read("b4_QJS0R.loom", cache=True)

adata= B_1.concatenate([B_2, B_3, B_4])
adata
...
adata
AnnData object with n_obs × n_vars = 11572 × 16754 
    obs: 'batch', 'n_genes', 'n_counts', 'percent_mito', 'percent_ribo'
...
Cluster 0 Chondrofibroprogenitor
Cluster 1 Endothelial cell
Cluster 2 Chondrofibroprogenitor2
Cluster 3 Bone lining fibroblast
Cluster 4 Chondrocyte
Cluster 5 Smooth Muscle Cell
Cluster 6 BM-MSC
Cluster 7: Tenocyte
Cluster 8: OsP
Cluster 9: Macrophage/Monocyte/ B cell
...
# Subset
a= adata_all[adata_all.obs['louvain'].isin(['0', '2', '3', '5', '6', '7', '8'])].obs.index
