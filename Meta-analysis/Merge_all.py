...
adata3_raw=  sc.read("GSM3937217_VRRW0.loom", cache=True)
adata4_raw = scv.read("Addo_ZYBAF.loom", cache=True)
adata5_raw= sc.read("Tikhonova_MSC_7wk_0BK8W.loom", cache=True)
adata6_raw= sc.read("Tikhonova_MSC_12wk_SKB70.loom", cache=True)
adata7_raw= B_1.concatenate([B_2, B_3, B_4])
adata8_raw=  sc.read("GSM3466901_YRHA5.loom", cache=True)
adata9_raw= MSC1.concatenate([MSC2, MSC3, MSC4])
adata10_raw= sc.read("Wolock_MSC_QCTZ0.loom", cache=True)
