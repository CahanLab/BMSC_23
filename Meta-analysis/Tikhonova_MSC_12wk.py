...
adata= sc.read("Tikhonova_MSC_12wk_SKB70.loom")
adata
...
adata= sc.read("/Users/raycheng/Dropbox (CahanLab)/BMSC_Meta/Data/Tikhonova_Nature_2019/Tikhonova_MSC_12wk_SKB70.loom")
adata
