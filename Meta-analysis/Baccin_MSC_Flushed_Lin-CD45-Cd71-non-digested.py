...
adata=  sc.read("GSM3937216_D6GM2.loom", cache=True)
adata
...
#Cluster 0: CAR cell
#Cluster 1: Microphage/Monocyte  (CD14, Fcgr3+)
#Cluster 2: Osteoblast
#Cluster 3: Microphage/Monocyte (Fcgr3+)
#Cluster 4: B cell


# subsetting
a= adata_all[adata_all.obs['louvain'].isin(['0', '2'])].obs.index
adata=  sc.read("GSM3937216_D6GM2.loom", cache=True)
adata
